...
. cmd.sh  0 0 2_4_6  -p DomainNet --task true_domains  --tmux TAT_0
. cmd.sh  1 0 8_10_12_14  -p DomainNet --task true_domains  --tmux TAT_1
...
# . cmd.sh  0 0 1_3_5_7  -p DomainNet --task true_domains  --tmux TAT_0
# . cmd.sh  1 0 9_11_13  -p DomainNet --task true_domains  --tmux TAT_1
